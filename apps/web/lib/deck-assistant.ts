...
export async function askDeckAssistant(input:{format:string;commander?:ScryfallCard;candidates:ScryfallCard[];ownedNames:Set<string>;budgetCents:number|null;theme:string|null;colors:string[];targetNonlandCount:number;currentDeck?:Array<{name:string;quantity:number;section:string}>}):Promise<AssistantPlan|null>{
